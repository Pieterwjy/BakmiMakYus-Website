<nav class="navbar sticky-top navbar-expand-lg bg-light py-3">
    <div class="container-fluid ">
      <a class="navbar-brand" href="{{ route('owner.dashboard') }}"><img src={{asset('logo/logo.png')}} width="60" height="60">Bakmi MakYus - Pemilik Dasbor</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link {{ ($title === "Akun") ? 'active' : "" }}" aria-current="page" href="{{ route('owner.akun.index') }}">Akun</a>
          </li>
          <li class="nav-item">
